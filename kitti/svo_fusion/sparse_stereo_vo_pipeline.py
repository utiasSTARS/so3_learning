...
class SparseStereoPipeline(object):
    def __init__(self, hydranet_output_file, pipeline_params=SparseStereoPipelineParams()):
    ...
    def _load_hydranet_files(self, path):
        ...
        #elf.Sigma_21_hydranet_const, self.C_21_hydranet_bias = self.compute_rot_covar()
    ...
    def track(self):
        ...
        optimizer.add_orientation_residual(C_21_hn, invsqrt(Sigma_21_hn))
