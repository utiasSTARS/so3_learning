...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(PlanetariumData(train_dataset, k_range=k_range_train, normalization=normalization, mat_targets=True),
                        batch_size=args.batch_size, pin_memory=True, 
                        shuffle=True, num_workers=1, drop_last=False)
    valid_loader = DataLoader(PlanetariumData(valid_dataset, k_range=k_range_valid,normalization=normalization, mat_targets=True),
                        batch_size=args.batch_size, pin_memory=True,
