...
def main():
    ...
    kitti_basedir = '/media/m2-drive/datasets/KITTI/distorted_images'
    saved_tracks_dir = '/media/raid5-array/datasets/KITTI/extracted_sparse_tracks/distorted'
  
    bad_intrinsics = False
    bad_intrinsics_dir = '/media/raid5-array/experiments/Deep-PC/stereo_vo_results/baseline_bad_intrinsics'

    baseline_dir = '/media/raid5-array/experiments/Deep-PC/stereo_vo_results/baseline_distorted'
    ...
    for seq in compute_seqs:
        ...
        if bad_intrinsics:
            ...
            stats_plots_path = os.path.join(export_dir, 'stats')
