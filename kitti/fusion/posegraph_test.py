...
C_6_2_obs = T_6_0_true.dot(T_2_0_true.inv()).rot
...
rot_stiffness = invsqrt(1e-3 * np.identity(3))
...
residualrot = PoseToPoseOrientationResidual(C_6_2_obs, rot_stiffness)
residualrot_params = ['T_2_0', 'T_6_0']
...
problem.add_residual_block(residualrot, residualrot_params)
